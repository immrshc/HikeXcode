...
class TestViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, TestLayoutDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let layout = collectionView?.collectionViewLayout as? TestLayout {
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier("TestCollectionViewCell", forIndexPath: indexPath) as! TestCollectionViewCell
